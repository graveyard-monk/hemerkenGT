 ...
 * @since      1.0.0
 */
class hemerken_gt_Block_One_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			$query = apply_filters( 'hemerken_gt_home_one_column_args', $args );
 ...
 * @since 1.0.0
 */
function hemerken_gt_home_one_column_meta() {
	...
	$html = '<div class="entry-meta">';
		...
		if ( $category && hemerken_gt_categorized_blog() ) {
